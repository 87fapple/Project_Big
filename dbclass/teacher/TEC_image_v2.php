...
$data = file_get_contents('https://animals.sandiegozoo.org/sites/default/files/2016-08/hero_zebra_animals.jpg');
$image = new Image($data);
$image->resize(200, 200, 'aspectfill');    // fill, aspectfill, aspectfit
